...
void Print_An_Array(int array[],int weight[],int size,float sum)
{
	//printf("%d\n",sum);
	cout<<sum<<endl;
	arr1.resize(size);
...
int main()
{
    ...
    // Add_New_Edge(graph, 0, 1, 4);
    // Add_New_Edge(graph, 0, 7, 8);
    // Add_New_Edge(graph, 1, 2, 8);
    // Add_New_Edge(graph, 1, 7, 11);
    // Add_New_Edge(graph, 2, 3, 7);
    // Add_New_Edge(graph, 2, 8, 2);
    // Add_New_Edge(graph, 2, 5, 4);
    // Add_New_Edge(graph, 3, 4, 9);
    // Add_New_Edge(graph, 3, 5, 14);
    // Add_New_Edge(graph, 4, 5, 10);
    // Add_New_Edge(graph, 5, 6, 2);
    // Add_New_Edge(graph, 6, 7, 1);
    // Add_New_Edge(graph, 6, 8, 6);
    // Add_New_Edge(graph, 7, 8, 7);
